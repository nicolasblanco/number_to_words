...
RSpec.describe NumberToWords do
  ...
  describe '.convert_until_thousand_until_thousand' do
    it 'converts a single number' do
    ...
    it 'converts one hundred something' do
      ...
      expect(subject.convert_until_thousand(100)).to eq("one hundred")
    end

    it 'converts X hundred something' do
      expect(subject.convert_until_thousand(300)).to eq("three hundred")
